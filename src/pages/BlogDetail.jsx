...
export default function BlogDetail() {
  ...
  return (
    <div className="bg-[#FAFAF7] text-[#161616] font-sans min-h-screen pt-16 sm:pt-24 pb-20 relative selection:bg-[#161616] selection:text-white bg-grid-dots bg-grain">
      ...
      >
        ...
        <article className="space-y-10">
          ...
          <motion.div variants={fadeInUp} className="space-y-4 text-left">
            ...
            <h1 className="font-sans text-2xl sm:text-3xl lg:text-[38px] font-black uppercase tracking-tight text-[#161616] leading-[1.15]">
              {blog.title}
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className={`space-y-8 ${blog.image ? 'lg:col-span-6' : 'lg:col-span-12'}`}>
              ...
              <motion.div 
                variants={fadeInUp}
                className="font-sans text-[14px] sm:text-base md:text-[17px] text-[#161616]/80 leading-[2.0] space-y-6 whitespace-pre-line text-left bg-white border border-neutral-200/50 rounded-[32px] p-5 sm:p-8 md:p-12 shadow-xs"
              >
                {blog.content}
              </motion.div>
            </div>
