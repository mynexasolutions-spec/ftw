...
import { Globe, Save, Plus, Trash, Image, Link, Clock, Sparkles, Upload } from 'lucide-react'
      ...
      <div className="space-y-8 text-xs font-sans">
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-cream3 p-5 sm:p-6 rounded-3xl space-y-5 hover:border-dark/25 hover:shadow-md transition-all duration-300 shadow-sm">
          <div className="flex items-center gap-3 border-b border-cream3 pb-3">
            ...
            <div>
              <h3 className="text-sm font-black uppercase text-dark tracking-wider">1. Hero Section Slider</h3>
              <p className="text-[9px] text-dark2/45 uppercase mt-0.5 font-bold font-mono">Manage carousel photos rotating on the landing slide banner (Max 5 images)</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
              {config.hero_images.map((img, idx) => (
                <div key={idx} className="border border-cream3 rounded-2xl overflow-hidden bg-cream/20 flex flex-col group relative">
                  <div className="aspect-[3/4] w-full bg-cream3 relative overflow-hidden">
                    <img src={img} alt="Hero Banner" className="w-full h-full object-contain bg-cream3" onError={(e) => { e.target.src = '/images/Regular-T.png' }} />
                    <button
                      type="button"
                  ...
                  <div className="p-2.5 font-sans font-bold text-[10px] text-dark/80 border-t border-cream3 bg-white uppercase tracking-wider text-center">
                    Hero Banner #{idx + 1}
                  </div>
                </div>
              ))}
          ...
          <div className="flex justify-end pt-3 border-t border-cream3 mt-4">
            ...
            >
              <Save className="w-3.5 h-3.5" /> Save Hero Slider
            </button>
          </div>
        </form>
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-cream3 p-5 sm:p-6 rounded-3xl space-y-5 hover:border-dark/25 hover:shadow-md transition-all duration-300 shadow-sm">
          <div className="flex items-center gap-3 border-b border-cream3 pb-3">
            ...
            <div>
              <h3 className="text-sm font-black uppercase text-dark tracking-wider">2. Featured Collection Products</h3>
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-cream3 p-5 sm:p-6 rounded-3xl space-y-5 hover:border-dark/25 hover:shadow-md transition-all duration-300 shadow-sm">
          <div className="flex items-center gap-3 border-b border-cream3 pb-3">
            ...
            <div>
              <h3 className="text-sm font-black uppercase text-dark tracking-wider">3. Sale Archive Products</h3>
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-cream3 p-5 sm:p-6 rounded-3xl space-y-6 hover:border-dark/25 hover:shadow-md transition-all duration-300 shadow-sm">
          <div className="flex items-center gap-3 border-b border-cream3 pb-3">
            ...
            <div>
              <h3 className="text-sm font-black uppercase text-dark tracking-wider">4. Next Drop Teaser & Countdown</h3>
