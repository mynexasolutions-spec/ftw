  ...
  return (
    <div className="space-y-8 animate-fade-in pb-12 text-dark font-sans">
      ...
      <div className="grid grid-cols-3 gap-2.5 sm:gap-6">
        ...
        >
          <div>
            <span className="text-[8.5px] xs:text-[9.5px] sm:text-[10px] lg:text-xs font-sans font-black text-purple-700/80 uppercase tracking-widest block">Active Coupons</span>
            <p className="text-lg xs:text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-black text-purple-955 mt-0.5 sm:mt-1 font-sans">{totalCoupons}</p>
          </div>
          <div className="flex justify-between items-center mt-1.5 sm:mt-3">
            <span className="text-[7.5px] xs:text-[8.5px] sm:text-[9px] lg:text-[10px] font-extrabold text-purple-600 bg-purple-50/90 px-1.5 py-0.5 rounded border border-purple-150/50">Live Codes</span>
            <div className="p-1 sm:p-2 lg:p-2.5 bg-white rounded-xl shadow-xs text-purple-700 shrink-0 border border-purple-100 group-hover:scale-110 transition-transform">
              <Tag className="w-3 h-3 sm:w-4 sm:h-4 lg:w-4.5 lg:h-4.5 text-accent fill-accent" />
            </div>
          </div>
        </motion.div>
        ...
        >
          <div>
            <span className="text-[8.5px] xs:text-[9.5px] sm:text-[10px] lg:text-xs font-sans font-black text-amber-700/80 uppercase tracking-widest block">Percent Codes</span>
            <p className="text-lg xs:text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-black text-amber-955 mt-0.5 sm:mt-1 font-sans">{percentCount}</p>
          </div>
          <div className="flex justify-between items-center mt-1.5 sm:mt-3">
            <span className="text-[7.5px] xs:text-[8.5px] sm:text-[9px] lg:text-[10px] font-extrabold text-amber-600 bg-amber-50/90 px-1.5 py-0.5 rounded border border-amber-150/50">Percent Off</span>
            <div className="p-1 sm:p-2 lg:p-2.5 bg-white rounded-xl shadow-xs text-amber-700 shrink-0 border border-amber-100 group-hover:scale-110 transition-transform">
              <Percent className="w-3 h-3 sm:w-4 sm:h-4 lg:w-4.5 lg:h-4.5" />
            </div>
          </div>
        </motion.div>
        ...
        >
          <div>
            <span className="text-[8.5px] xs:text-[9.5px] sm:text-[10px] lg:text-xs font-sans font-black text-blue-700/80 uppercase tracking-widest block">Flat Discount</span>
            <p className="text-lg xs:text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-black text-blue-955 mt-0.5 sm:mt-1 font-sans">{flatCount}</p>
          </div>
          <div className="flex justify-between items-center mt-1.5 sm:mt-3">
            <span className="text-[7.5px] xs:text-[8.5px] sm:text-[9px] lg:text-[10px] font-extrabold text-blue-600 bg-blue-50/90 px-1.5 py-0.5 rounded border border-blue-150/50">Cash Off (₹)</span>
            <div className="p-1 sm:p-2 lg:p-2.5 bg-white rounded-xl shadow-xs text-blue-700 shrink-0 border border-blue-100 group-hover:scale-110 transition-transform">
              <IndianRupee className="w-3 h-3 sm:w-4 sm:h-4 lg:w-4.5 lg:h-4.5" />
            </div>
          </div>
        </motion.div>
      </div>
