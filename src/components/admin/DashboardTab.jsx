  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-6">
        ...
        <div className="bg-gradient-to-br from-violet-50/60 to-purple-100/30 hover:to-purple-200/40 border border-purple-100 hover:border-purple-200 p-4 sm:p-5 rounded-2xl shadow-xs hover:shadow-md transition-all duration-300 relative overflow-hidden flex flex-col justify-between min-h-[110px] sm:min-h-[125px] group hover:-translate-y-1">
          ...
          <div className="flex justify-between items-center mt-2 sm:mt-3">
            <span className="text-[8px] sm:text-[9px] font-bold text-purple-600 bg-purple-50/60 px-1.5 py-0.5 rounded border border-purple-100/50 truncate">All-time paid</span>
            <div className="p-1.5 sm:p-2 bg-white rounded-xl shadow-sm text-purple-700 shrink-0 border border-purple-100 group-hover:scale-110 transition-transform">
              <IndianRupee className="w-3.5 h-3.5 sm:w-4.5 sm:h-4.5" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-50/60 to-indigo-100/30 hover:to-indigo-200/40 border border-blue-100 hover:border-blue-200 p-4 sm:p-5 rounded-2xl shadow-xs hover:shadow-md transition-all duration-300 relative overflow-hidden flex flex-col justify-between min-h-[110px] sm:min-h-[125px] group hover:-translate-y-1">
          ...
          <div className="flex justify-between items-center mt-2 sm:mt-3">
            <span className="text-[8px] sm:text-[9px] font-bold text-blue-600 bg-blue-50/60 px-1.5 py-0.5 rounded border border-blue-100/50 truncate">Placed orders</span>
            <div className="p-1.5 sm:p-2 bg-white rounded-xl shadow-sm text-blue-700 shrink-0 border border-blue-100 group-hover:scale-110 transition-transform">
        ...
        <div className="bg-gradient-to-br from-amber-50/60 to-orange-100/30 hover:to-orange-200/40 border border-orange-100 hover:border-orange-200 p-4 sm:p-5 rounded-2xl shadow-xs hover:shadow-md transition-all duration-300 relative overflow-hidden flex flex-col justify-between min-h-[110px] sm:min-h-[125px] group hover:-translate-y-1">
          ...
          <div className="flex justify-between items-center mt-2 sm:mt-3">
            <span className="text-[8px] sm:text-[9px] font-bold text-amber-600 bg-amber-50/60 px-1.5 py-0.5 rounded border border-amber-100/50 truncate">Awaiting dispatch</span>
            <div className="p-1.5 sm:p-2 bg-white rounded-xl shadow-sm text-amber-700 shrink-0 border border-orange-100 group-hover:scale-110 transition-transform">
        ...
        <div className="bg-gradient-to-br from-emerald-50/60 to-teal-100/30 hover:to-teal-200/40 border border-teal-100 hover:border-teal-200 p-4 sm:p-5 rounded-2xl shadow-xs hover:shadow-md transition-all duration-300 relative overflow-hidden flex flex-col justify-between min-h-[110px] sm:min-h-[125px] group hover:-translate-y-1">
          ...
          <div className="flex justify-between items-center mt-2 sm:mt-3">
            <span className="text-[8px] sm:text-[9px] font-bold text-emerald-600 bg-emerald-50/60 px-1.5 py-0.5 rounded border border-teal-100/50 truncate">Per transaction</span>
            <div className="p-1.5 sm:p-2 bg-white rounded-xl shadow-sm text-emerald-700 shrink-0 border border-teal-100 group-hover:scale-110 transition-transform">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
        ...
        <div className="bg-white border border-cream3 p-6 rounded-2xl space-y-4 shadow-xs">
          <div className="flex justify-between items-center border-b border-cream2 pb-2">
            <h4 className="text-[11px] font-mono uppercase text-dark/50 font-black flex items-center gap-1.5">
      ...
      <div className="space-y-4">
        <h3 className="font-sans text-xs uppercase tracking-wider text-dark2/70 font-bold">Recent Transactions</h3>
        <div className="bg-white border border-cream3 rounded-2xl overflow-hidden shadow-sm">
          {orders.length === 0 ? (
            <div className="p-8 text-center text-dark2/50 font-sans text-xs">
                      ...
                      <tr key={o.id} className="hover:bg-cream/20 transition-colors group">
                        <td className="p-4">
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-dark/5 text-dark/80 group-hover:bg-dark group-hover:text-cream flex items-center justify-center font-bold text-xs uppercase border border-cream3 transition-colors shrink-0">
                              {initials}
                            </div>
                            <div>
                              <div className="flex items-center gap-2">
                                <span className="font-bold text-dark block text-xs">{o.customer_name}</span>
                                {isCustom && (
                                  <span className="bg-orange-50 text-orange-600 border border-orange-100 text-[8px] font-black uppercase px-1.5 py-0.5 rounded tracking-wide shrink-0">
                                    Custom Print
                                  </span>
                                )}
                              </div>
                        ...
                        <td className="p-4">
                          <span className={`text-[9px] uppercase px-2.5 py-1 rounded-full font-bold border ${
                            o.status === 'Delivered' ? 'bg-green-50 text-green-700 border-green-150' :
                            o.status === 'Dispatched' ? 'bg-blue-550 text-blue-700 border-blue-150' :
