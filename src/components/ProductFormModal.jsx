...
import { X, CheckCircle, Trash2, Upload, AlertCircle, Sparkles, Plus, Image as ImageIcon, Star, Zap, ChevronLeft, ChevronRight } from 'lucide-react'
  ...
  const validateStep = (step) => {
    ...
    if (step === 4) {
      if (!productForm.colors || productForm.colors.length === 0) {
        errors.colors = "Select at least one active color variant";
      } else if (productForm.is_combo && productForm.colors.length !== 2) {
        errors.colors = "For combos, you must select/add exactly 2 colors.";
      }
    }
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 font-sans">
      ...
      <motion.div
        ...
        className="bg-[#FAFAF7] border-2 border-cream3 w-full max-w-5xl rounded-2xl sm:rounded-[32px] shadow-2xl relative z-10 text-sm font-sans max-h-[92vh] overflow-hidden"
      >
        <div className="max-h-[92vh] overflow-y-auto p-4 sm:p-8 modal-purple-scrollbar">
          {/* Header Title Bar */}
          <div className="flex justify-between items-center border-b border-cream3 pb-5 mb-8 select-none">
            <div>
              <span className="text-xs text-accent font-black uppercase tracking-widest">Catalog Operations</span>
              <h3 className="text-3xl font-black uppercase text-dark tracking-tight leading-none mt-1.5">
          ...
          <div className="flex items-center justify-between gap-2 bg-[#F6F5EF] border border-cream3 p-3 rounded-2xl mb-8 select-none overflow-x-auto scrollbar-none">
            {[
              ...
              return (
                ...
                >
                  <span className={`w-5 h-5 rounded-full flex items-center justify-center text-[9px] font-black ${isActive
          ...
          <form onSubmit={onSave} className="space-y-8">
            <div className="w-full">
              ...
              <div className="space-y-8">
                ...
                {/* Step 1: Core Details */}
                {activeStep === 1 && (
                  <div className="bg-[#FAF9F5] border-2 border-cream3 p-4 sm:p-5 rounded-2xl space-y-4 shadow-sm transition-all">
                    <div className="flex items-center justify-between border-b border-cream3 pb-2.5">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <span className="text-xs text-dark font-black uppercase tracking-widest block">1. Details & Logistics</span>
                          <span className="text-[10.5px] text-dark/50 uppercase font-medium block mt-0.5">Configure product identity, SKU reference, weight, category, and catalog status.</span>
                        </div>
                      </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-3">
                        <div className="space-y-1.5">
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-2 bg-cream2/50 border rounded-xl focus:outline-none focus:bg-white text-sm font-sans font-bold text-dark transition-all placeholder:text-xs placeholder:font-normal placeholder:opacity-50 ${stepErrors.name ? 'border-red-500 bg-red-50/20 focus:border-red-500' : 'border-cream3 focus:border-dark'
                              }`}
                        ...
                        <div className="space-y-1.5">
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-2 bg-cream2/50 border rounded-xl focus:outline-none focus:bg-white text-sm font-sans font-bold text-dark transition-all placeholder:text-xs placeholder:font-normal placeholder:opacity-50 ${stepErrors.sku ? 'border-red-500 bg-red-50/20 focus:border-red-500' : 'border-cream3 focus:border-dark'
                              }`}
                        ...
                        <div className="space-y-1.5">
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-2 bg-cream2/50 border rounded-xl focus:outline-none focus:bg-white text-sm font-sans font-bold text-dark transition-all placeholder:text-xs placeholder:font-normal placeholder:opacity-50 ${stepErrors.weight ? 'border-red-500 bg-red-50/20 focus:border-red-500' : 'border-cream3 focus:border-dark'
                              }`}
                            placeholder="0.25"
                          />
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-1.5">
                          <label className="text-xs uppercase font-black text-dark2/60 block">Subcategory Label <span className="text-[10px] font-bold text-dark/65 font-mono normal-case">(Optional)</span></label>
                          <input
                            type="text" value={productForm.subcategory || ''} onChange={(e) => setProductForm({ ...productForm, subcategory: e.target.value })}
                            className="w-full px-4 py-2 bg-cream2/50 border border-cream3 rounded-xl focus:outline-none focus:bg-white focus:border-dark text-sm font-sans font-bold text-dark transition-all placeholder:text-xs placeholder:font-normal placeholder:opacity-50"
                    ...
                    {/* Bottom Row Toggles Sub-grid */}
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 pt-4 border-t border-cream3/60">
                      {/* Store Visibility Toggle */}
                      <div className="space-y-1.5">
                        <label className="text-xs uppercase font-black text-dark2/60 block">Visibility Status</label>
                        <div className="bg-white border border-cream3 px-4 py-2 rounded-xl flex items-center justify-between gap-3 min-h-[46px] select-none shadow-2xs">
                          <div className="leading-tight">
                            <label className="text-xs uppercase font-black text-dark block">Catalog Active</label>
                            <span className="text-[10.5px] font-sans font-bold text-dark2/60 uppercase block">Visible in storefront?</span>
                          </div>
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs uppercase font-black text-dark2/60 block">Customization Available</label>
                        <div className="bg-white border border-cream3 px-4 py-2 rounded-xl flex items-center justify-between gap-3 min-h-[46px] select-none shadow-2xs">
                          <div className="leading-tight">
                            <label className="text-xs uppercase font-black text-dark block">Enable Customizer</label>
                            <span className="text-[10.5px] font-sans font-bold text-dark2/60 uppercase block">Show customizable button?</span>
                          </div>
                          <label className="relative inline-flex items-center cursor-pointer select-none shrink-0 scale-95">
                            <input
                              type="checkbox"
                              checked={productForm.customizable || false}
                      ...
                      {/* Combo Pack Toggle */}
                      <div className="space-y-1.5">
                        <label className="text-xs uppercase font-black text-dark2/60 block">Combo Product</label>
                        <div className="bg-white border border-cream3 px-4 py-2 rounded-xl flex items-center justify-between gap-3 min-h-[46px] select-none shadow-2xs">
                          <div className="leading-tight">
                            <label className="text-xs uppercase font-black text-dark block">Is Combo Pack?</label>
                            <span className="text-[10.5px] font-sans font-bold text-dark2/60 uppercase block">Contains multiple T-shirts?</span>
                          </div>
                          <label className="relative inline-flex items-center cursor-pointer select-none shrink-0 scale-95">
                            <input
                              type="checkbox"
                              checked={productForm.is_combo || false}
                              onChange={(e) => setProductForm({ ...productForm, is_combo: e.target.checked })}
                              className="sr-only peer"
                            />
                            <div className="w-9 h-5 bg-cream3 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-dark"></div>
                          </label>
                  ...
                  <div className="bg-[#FAF9F5] border-2 border-cream3 p-6 sm:p-8 rounded-3xl space-y-6 shadow-sm transition-all">
                    <div className="flex items-center justify-between border-b border-cream3 pb-4">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <span className="text-xs text-dark font-black uppercase tracking-widest block">2. Specifications & Guide</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                          <label className="text-xs uppercase font-black text-dark2/60 block">Size Guide Notes <span className="text-[10px] font-bold text-dark/65 font-mono normal-case">(Optional)</span></label>
                          <textarea
                ...
                {activeStep === 3 && (
                  <div className={`border-2 p-6 rounded-3xl space-y-6 shadow-sm transition-all ${stepErrors.sizes ? 'bg-red-50/15 border-red-500' : 'bg-[#FAF9F5] border-cream3 hover:border-dark/15'
                    ...
                    <div className="flex items-center gap-2 border-b border-cream3 pb-2.5">
                      ...
                      <span className="text-xs text-dark font-black uppercase tracking-widest">3. Sizes Matrix & Chart</span>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2 pt-1">
                        <span className="text-[10.5px] font-sans font-bold text-dark2/60 uppercase tracking-wider block">Waist / Numerical Sizes</span>
                        <div className="flex flex-wrap gap-2">
                      ...
                      <div className="pt-2.5">
                        <span className="text-[10.5px] font-sans font-bold text-dark2/60 uppercase tracking-wider block mb-1.5">Add Custom Size</span>
                  ...
                  <div className={`border-2 p-6 sm:p-8 rounded-3xl space-y-6 shadow-sm transition-all ${stepErrors.colors ? 'bg-red-50/15 border-red-500' : 'bg-[#FAF9F5] border-cream3 hover:border-dark/15'
                    ...
                    <div className="flex items-center justify-between border-b border-cream3 pb-4">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <span className="text-xs text-dark font-black uppercase tracking-widest block">4. Colors Matrix & Swatches</span>
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-cream3 space-y-4 shadow-xs">
                      <div className="flex justify-between items-center border-b border-cream2 pb-3">
                        <div>
                          ...
                          <span className="text-[10.5px] font-sans font-bold text-dark2/60 uppercase block mt-0.5">Click the star icon on any swatch to make it the landing default.</span>
                        </div>
                      ...
                      <div className="lg:col-span-7 bg-white p-6 rounded-2xl border border-cream3 space-y-4 shadow-xs flex flex-col justify-between">
                        <div>
                          <div className="border-b border-cream2 pb-3 mb-4">
                            ...
                            <span className="text-[10.5px] font-sans font-bold text-dark2/60 uppercase block mt-0.5">Click any standard color swatch below to toggle in your catalog.</span>
                          </div>
                              ...
                              return (
                                <button
                                  ...
                                  onClick={() => {
                                    ...
                                    if (productForm.is_combo && productForm.colors.length >= 2) {
                                      toast.error("For combos, you can select exactly 2 colors.")
                                      return
                                    }
                                    setProductForm({
                                      ...productForm,
                      ...
                      <div className="lg:col-span-5 bg-white p-6 rounded-2xl border border-cream3 space-y-4 shadow-xs flex flex-col justify-between">
                        <div>
                          <div className="border-b border-cream2 pb-3 mb-4">
                            ...
                            <span className="text-[10px] text-dark/40 uppercase block mt-0.5">Pick a color hex and define a custom swatch name.</span>
                          </div>
                  ...
                  <div className="bg-[#FAF9F5] border-2 border-cream3 p-6 sm:p-8 rounded-3xl space-y-8 shadow-sm transition-all">
                    ...
                    <div className="flex items-center justify-between border-b border-cream3 pb-4">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <span className="text-xs text-dark font-black uppercase tracking-widest block">5. Variant Pricing & Gallery Studio</span>
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="space-y-2.5">
                            <div className="flex justify-between items-center">
                              ...
                              <span className="text-[10px] font-sans font-bold text-dark/40 uppercase">Active Tab: {cleanedColorName}</span>
                            </div>
                          ...
                          <div className="bg-white border border-cream3 p-6 sm:p-8 rounded-2xl space-y-6 shadow-xs">
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <h4 className="font-display text-base font-black uppercase text-dark tracking-tight">
                                    <span className="font-bold normal-case text-black">Configuring: </span>
                                    <span className="text-accent">{cleanedColorName}</span>
                                  </h4>
                                  <span className="text-[10px] text-dark/40 font-sans font-bold uppercase block mt-0.5">Overrides assigned specifically to this color option</span>
                                </div>
                              </div>
                              <span className="text-[10px] font-sans font-black uppercase px-3 py-1 bg-[#FAF9F6] border border-cream3 rounded-lg text-dark/60">
                                {selectedImages.length} {selectedImages.length === 1 ? 'Asset' : 'Assets'} Attached
                              </span>
                            </div>

                            {/* Selected Image Ordering list */}
                            {selectedImages.length > 0 && (
                              <div className="space-y-2 pb-4 border-b border-cream2">
                                <span className="text-[10px] uppercase font-black text-dark/60 block">Selected Images Order (Reorder Items)</span>
                                <div className="flex flex-wrap gap-3 p-3.5 bg-[#FAF9F6]/50 border border-cream3 rounded-2xl">
                                  {selectedImages.map((imgUrl, idx) => {
                                    return (
                                      <div key={imgUrl} className="relative w-16 h-20 rounded-xl overflow-hidden border border-cream3 bg-white group flex flex-col justify-between shadow-2xs">
                                        <img src={imgUrl} alt="selected" className="w-full h-12 object-cover" />

                                        {/* Move Controls */}
                                        <div className="flex justify-between items-center bg-dark p-1 text-[9px]">
                                          <button
                                            type="button"
                                            disabled={idx === 0}
                                            onClick={() => {
                                              ...
                                              const vIdx = currentVariants.findIndex(v => v.color === cleanedColorName);
                                              if (vIdx > -1) {
                                                currentVariants[vIdx] = { ...currentVariants[vIdx], images: newSelected };
                                              }
                                              const isDefaultColor = productForm.default_color === cleanedColorName || (!productForm.default_color && (productForm.colors && productForm.colors.length > 0 ? productForm.colors[0].replace(/\s*\(#[0-9a-fA-F]{3,6}\)/, '').trim() : 'Black') === cleanedColorName);
                                              const updatedMainImage = isDefaultColor && newSelected.length > 0 ? newSelected[0] : productForm.image;
                                              setProductForm({ ...productForm, variants: currentVariants, image: updatedMainImage });
                                            }}
                                            className="p-0.5 text-white border-none bg-transparent cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center"
                                          >
                                            <ChevronLeft className="w-3 h-3" />
                                          </button>
                                          <span className="text-[9px] text-white/80 font-sans font-extrabold">#{idx + 1}</span>
                                          <button
                                            type="button"
                            ...
                            {/* TOP ROW: Upload Box (Left) & Gallery Images (Right) */}
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                              ...
                              <div className="lg:col-span-4 space-y-3.5 flex flex-col justify-between">
                                <div className="border-b border-cream2 pb-2.5">
                                  ...
                                  <span className="text-[10px] text-dark/40 font-sans font-bold uppercase block mt-0.5">Upload new photos for {cleanedColorName}.</span>
                                </div>
                                ...
                                <label className="group flex-grow border-2 border-dashed border-cream3 hover:border-dark hover:bg-[#FAF9F6] rounded-2xl p-6 flex flex-col items-center justify-center gap-3 cursor-pointer transition-all duration-200 bg-[#FAF9F6]/50 min-h-[180px]">
                                  ...
                                  <div className="text-center select-none">
                                    ...
                                    <span className="text-[9px] text-dark/40 font-sans font-bold uppercase tracking-wider block mt-1">PNG / JPG to Cloudinary</span>
                                  </div>
                                  <input
                                    type="file"
                                    multiple
                              ...
                              <div className="lg:col-span-8 space-y-3.5">
                                <div className="border-b border-cream2 pb-2.5 flex justify-between items-center">
                                  <div>
                                    ...
                                    <span className="text-[10px] text-dark/40 font-sans font-bold uppercase block mt-0.5">Select store media to link with {cleanedColorName}.</span>
                                  </div>
                                  <span className="text-[10px] font-sans font-black uppercase text-accent bg-accent/10 px-2.5 py-1 rounded-md">
                                    {selectedImages.length} Selected
                                  </span>
                                </div>

                                {(!productForm.images || productForm.images.length === 0) ? (
                                  <div className="p-8 border border-dashed border-cream3 rounded-2xl text-center text-xs text-dark/30 font-bold font-sans bg-[#FAF9F6] min-h-[180px] flex items-center justify-center">
                                      ...
                                      return (
                                        ...
                                        >
                                          ...
                                          <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-dark/80 to-transparent p-1.5 text-left">
                                            <span className="text-[8px] font-sans font-black text-white/90 uppercase block">Photo #{imgIdx + 1}</span>
                                          </div>
                                        </div>
                                      );
                                    })}
                            ...
                            <div className="space-y-4 pt-6 border-t border-cream2">
                              <div className="flex justify-between items-center border-b border-cream2 pb-2">
                                <div>
                                  ...
                                  <span className="text-[9.5px] lg:text-[10.5px] text-dark/40 uppercase block mt-0.5">Configure regular MRP, sale price, and available inventory count for each size of {cleanedColorName}.</span>
                                </div>
                              </div>

                              {/* 1-Click Fast Bulk Fill Card */}
                              {productForm.sizes && productForm.sizes.length > 0 && (
                                <div className="bg-[#FAF9F5] border border-cream3 p-4 rounded-2xl space-y-3 shadow-xs">
                                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 border-b border-cream3/60 pb-2">
                                    <span className="text-[10px] lg:text-xs font-bold text-dark uppercase tracking-wider flex items-center gap-1.5">
                                      <Zap className="w-3.5 h-3.5 text-accent" /> 1-Click Fast Bulk Fill (Save Time)
                                    </span>
                                    <span className="text-[9px] text-dark/40 uppercase">Fill once & apply to all</span>
                                  </div>
                                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                    <div className="space-y-1">
                                      <span className="text-[9px] uppercase font-bold text-dark/50 block">Bulk Regular MRP (₹)</span>
                                      <input
                                        type="number"
                                        placeholder="e.g. 2499"
                                        value={bulkOriginalPrice}
                                        onChange={(e) => setBulkOriginalPrice(e.target.value)}
                                        className="w-full px-3 py-2 bg-white border border-cream3 rounded-xl text-xs font-bold focus:outline-none focus:border-dark placeholder:opacity-40"
                                      />
                                    </div>
                                    <div className="space-y-1">
                                      <span className="text-[9px] uppercase font-bold text-dark/50 block">Bulk Sale Price (₹)</span>
                                      <input
                                        type="number"
                                        placeholder="e.g. 1999"
                                        value={bulkPrice}
                                        onChange={(e) => setBulkPrice(e.target.value)}
                                        className="w-full px-3 py-2 bg-white border border-cream3 rounded-xl text-xs font-bold text-accent focus:outline-none focus:border-dark placeholder:opacity-40"
                                      />
                                    </div>
                                    <div className="space-y-1">
                                      <span className="text-[9px] uppercase font-bold text-dark/50 block">Bulk Stock Count</span>
                                      <input
                                        type="number"
                                        placeholder="e.g. 10"
                                        value={bulkStock}
                                  ...
                                  <div className="flex flex-wrap gap-2.5 pt-1">
                                    <button
                                      ...
                                      className="px-3.5 py-2 bg-dark hover:bg-accent hover:text-dark text-white rounded-xl text-[10px] lg:text-xs font-black uppercase tracking-wider cursor-pointer border-none transition-all flex items-center gap-1.5 shadow-xs"
                                    >
                                    ...
                                    <button
                                      ...
                                      className="px-3.5 py-2 bg-white hover:bg-cream3 text-dark border border-cream3 rounded-xl text-[10px] lg:text-xs font-black uppercase tracking-wider cursor-pointer transition-all flex items-center gap-1.5"
                                    >
                              ...
                              {(!productForm.sizes || productForm.sizes.length === 0) ? (
                                <div className="p-6 border border-dashed border-cream3 rounded-2xl text-center text-xs text-dark/40 font-medium bg-[#FAF9F6]">
                                ...
                                <div className="border border-cream3 rounded-2xl bg-white overflow-hidden shadow-xs">
                                  <div className="overflow-x-auto">
                                    <table className="w-full text-left border-collapse text-xs min-w-[500px]">
                                      <thead>
                                        <tr className="bg-[#FAF9F6] text-dark/70 font-bold border-b border-cream3 text-[10px] lg:text-xs uppercase tracking-wider">
                                        ...
                                        {productForm.sizes.map(sizeItem => {
                                          ...
                                          return (
                                            <tr key={sizeItem} className="hover:bg-cream2/15 transition-colors">
                                              <td className="p-3 lg:p-3.5 font-black text-dark text-xs lg:text-sm">{sizeItem}</td>
                                              <td className="p-3 lg:p-3.5">
                                                <div className="relative">
                                                  <span className="absolute left-3 top-2.5 text-xs text-dark/40 font-bold">₹</span>
                                                  <input
                                                    type="number"
                                                    placeholder="e.g. 2499"
                                                    ...
                                                    className="w-full pl-7 pr-3 py-2 bg-[#FAF9F6] border border-cream3 rounded-xl focus:outline-none focus:bg-white focus:border-dark text-xs font-bold placeholder:opacity-40"
                                                  />
                                                </div>
                                              </td>
                                              <td className="p-3 lg:p-3.5">
                                                <div className="relative">
                                                  <span className="absolute left-3 top-2.5 text-xs text-accent font-bold">₹</span>
                                                  <input
                                                    type="number"
                                                    placeholder="e.g. 1999"
                                                    value={variantPrice}
                                                    ...
                                                    className="w-full pl-7 pr-3 py-2 bg-[#FAF9F6] border border-cream3 rounded-xl focus:outline-none focus:bg-white focus:border-dark text-xs font-black text-accent placeholder:opacity-40"
                                                  />
                                                </div>
                                              </td>
                                              <td className="p-3 lg:p-3.5">
                                                <input
                                                  ...
                                                  className="w-full px-3.5 py-2 bg-[#FAF9F6] border border-cream3 rounded-xl focus:outline-none focus:bg-white focus:border-dark text-xs font-bold placeholder:opacity-40"
                                                />
                                              </td>
                                            </tr>
                                          );
                    ...
                    <div className="bg-white border border-cream3 p-6 sm:p-7 rounded-2xl space-y-4 shadow-xs">
                      <div className="border-b border-cream2 pb-3 flex items-center justify-between">
                        <div>
                          ...
                          <span className="text-[10.5px] font-sans font-bold text-dark2/60 uppercase block mt-0.5">Configure Google search tags and storefront badges.</span>
                        </div>
                        <span className="text-[9px] uppercase font-black text-accent bg-accent/10 px-2.5 py-1 rounded-md">Metadata Studio</span>
                      </div>
